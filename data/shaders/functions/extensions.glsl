...
vec4 texture(samplerCube sampler, vec3 coords)
{
...
#else
#error Your videocard does not support texture arrays. So you can't use SSGI effect. ���� ���������� �� ������������ ������� �������. SSGI �������� �� �����.
#endif
...
{
    float dist = 1.0 / texture(normalMap4, screenCoord).a - 1.0;
